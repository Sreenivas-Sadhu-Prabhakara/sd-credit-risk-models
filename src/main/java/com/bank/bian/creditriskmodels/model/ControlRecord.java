package com.bank.bian.creditriskmodels.model;
...
/**
 * The BIAN control record for this service domain: "Credit Risk Model Development Project".
 *
 ...
 * to its asset type (Credit Risk Model). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Credit Risk Model Development Project";
